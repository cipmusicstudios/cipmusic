...
export const LOCAL_IMPORT_METADATA_OVERRIDES: Record<string, LocalImportMetadataOverride> = {
  ...
  'beauty and a beat': {
    ...
    titles: { zhHans: 'Beauty And A Beat', zhHant: 'Beauty And A Beat', en: 'Beauty And A Beat' },
    artist: 'Justin Bieber',
    artists: { zhHans: 'Justin Bieber', zhHant: 'Justin Bieber', en: 'Justin Bieber' },
    categoryTags: ['欧美流行'],
    officialLinks: {
    ...
    matchedVideoTitle: 'Justin Bieber — Beauty And A Beat（用户指定 YouTube / Bilibili / Sheet）',
  },
  'BonBon Girls': {
    title: '心愿便利贴+BonBon Girls',
    displayTitle: '心愿便利贴+BonBon Girls',
    titles: { zhHans: '心愿便利贴+BonBon Girls', zhHant: '心願便利貼+BonBon Girls', en: 'Sticky Note Wish + BonBon Girls' },
    artist: '浪姐版',
    artists: { zhHans: '浪姐版', zhHant: '浪姐版', en: 'Sisters Edition' },
    categoryTags: ['华语流行'],
    officialLinks: {
      spotify: 'https://open.spotify.com/track/18WYdHm0rtDiidy0IK0GQM',
    },
    links: {
    ...
    matchedVideoTitle: '心愿便利贴+BonBon Girls（浪姐版，用户指定 YouTube / Bilibili / Sheet）',
  },
  "it's me": {
    title: "It's Me",
    displayTitle: "It's Me",
    titles: { zhHans: "It's Me", zhHant: "It's Me", en: "It's Me" },
    artist: 'ILLIT',
    artists: { zhHans: 'ILLIT', zhHant: 'ILLIT', en: 'ILLIT' },
    categoryTags: ['韩流流行'],
    officialLinks: {
      spotify: 'https://open.spotify.com/track/1D5L58KLBbceOynTP4DQnY',
    },
    links: {
    ...
    matchedVideoTitle: "ILLIT — It's Me（用户指定 YouTube / Bilibili / Sheet）",
  },
  'someone to love': {
    title: 'Someone to Love',
    displayTitle: 'Someone to Love',
    titles: { zhHans: 'Someone to Love', zhHant: 'Someone to Love', en: 'Someone to Love' },
    artist: '严浩翔',
    artists: { zhHans: '严浩翔', zhHant: '嚴浩翔', en: 'Yan Haoxiang' },
    categoryTags: ['华语流行'],
    officialLinks: {
      spotify: 'https://open.spotify.com/track/4UG43GqZxyhsOh3F3oGIGA',
    },
    links: {
  ...
  一个人想着一个人: {
    ...
    titles: { zhHans: '一个人想着一个人', zhHant: '一個人想著一個人', en: 'Thinking of Someone Alone' },
    artist: '曾沛慈',
    artists: { zhHans: '曾沛慈', zhHant: '曾沛慈', en: 'Pets Tseng' },
    categoryTags: ['华语流行', '影视'],
    officialLinks: {
      spotify: 'https://open.spotify.com/track/3n3zzFH7zzO0gJNaw4RKSm',
    },
    links: {
  ...
  "DNA": {
    ...
    cover: "https://i.scdn.co/image/ab67616d0000b2739c62340f99a122f333417a4a",
    officialLinks: {
      spotify: "https://open.spotify.com/track/40qwbrvCXsiOPh9xOupCMp?si=735830f50bb346ea"
    },
    links: {
  ...
  "Crow": {
    ...
    cover: "https://i.scdn.co/image/ab67616d0000b27361704fc49debfb58bfb7e074",
    officialLinks: {
      spotify: "https://open.spotify.com/track/4mZc0r3NFubFbe9xMOkZGJ?si=a9dda2314d3f41cd"
    },
    links: {
