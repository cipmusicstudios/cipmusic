...
export const ARTIST_DICTIONARY: Record<string, NormalizedArtist> = {
  ...
  'rose': { id: 'rose', names: { zhHans: 'ROSÉ', en: 'ROSÉ' }, type: 'solo', nationality: 'kr' },
  ...
  /** Drama OST duet — display as a single credited line */
  'yang-zi-xiao-zhan-duet': {
    id: 'yang-zi-xiao-zhan-duet',
    names: { zhHans: '杨紫、肖战', en: 'Yang Zi, Xiao Zhan' },
    type: 'group',
    nationality: 'zh',
  },
